...
public class Manager_ResendAuthCode extends AsyncTask<String[], Void, String> {

    private User user;
    private Listener_Login listener;

    public Manager_ResendAuthCode(User user, Listener_Login listener) {
        this.user = user;
...
//        appUserMap.put("Token", CommonVariables.TOKEN);
        ...
        appUserMap.put("defaultclientId", user.getDefaultClientId());
        appUserMap.put("uniqueValue", "" + user.getUniqueValue());
        appUserMap.put("jsonString", new Gson().toJson(user));
        ...
        Request request = new Request.Builder()
                .url(CommonVariables.BASE_URL + "ResendAuthCode")
                .post(body)
                .build();
