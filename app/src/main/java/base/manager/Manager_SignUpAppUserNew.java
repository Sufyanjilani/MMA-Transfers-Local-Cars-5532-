...
public class Manager_SignUpAppUserNew extends AsyncTask<String[], Void, String> {

    private User user;
    private Listener_Login listener;

    public Manager_SignUpAppUserNew(User user, Listener_Login listener) {
        this.user = user;
...
//        appUserMap.put("Token", CommonVariables.TOKEN);
        ...
        Request request = new Request.Builder()
                .url(CommonVariables.BASE_URL + "SignupAppUserNew")
                .post(body)
                .build();
