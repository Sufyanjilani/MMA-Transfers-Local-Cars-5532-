...
public class Manager_AuthorizeAppUserNew extends AsyncTask<String[], Void, String> {

    private User user;
    private Listener_Login listener;

    public Manager_AuthorizeAppUserNew(User user, Listener_Login listener) {
        this.user = user;
...
//        appUserMap.put("Token", CommonVariables.TOKEN);
        ...
        Request request = new Request.Builder()
                .url(CommonVariables.BASE_URL + "AuthorizeAppUserNew")
                .post(body)
                .build();
