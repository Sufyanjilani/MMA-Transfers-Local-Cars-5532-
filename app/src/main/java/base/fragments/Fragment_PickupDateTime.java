...
public class Fragment_PickupDateTime extends DialogFragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View ret = inflater.inflate(R.layout.layout_new_pickup_date_dialog, container, false);
...
//				    if (!cal.before(now)) {
                ...
                intent.putExtra(KEY_DATE, CommonVariables.getFormattedDate(cal, CommonVariables.FORMAT_DATE));
                intent.putExtra(KEY_TIME, CommonVariables.getFormattedDate(cal, CommonVariables.FORMAT_TIME));
//					intent.putExtra(KEY_RAW_DATE, cal);
